...
// func renderRowsX(sheet *xlsx.Sheet, rows []*xlsx.Row, ctx map[string]interface{}, options *Options) error {

// 	for _, row := range rows {

// 		prm := findPatternPrm(row)
// 		fmt.Println(prm)
...
// func findPatternPrm(in *xlsx.Row) string {
// 	for _, cell := range in.Cells {
// 		if cell.Value == "" {
// 			continue
// 		}
// 		if match := rgxPatternPrm.FindAllStringSubmatch(cell.Value, -1); match != nil {
// 			return match[0][1]
// 		}
// 	}
// 	return ""
...
// func getRangeCtxX(ctx map[string]interface{}, prop string) []map[string]interface{} {
// 	propsl := strings.Split(prop, ".")
...
// 	if len(propsl) > 1 {
// 		c := getRangeCtxX(c, strings.Join(propsl[1:], "."))
// 	}

// 	return c
// }

// возвращает номер ячейки, в которой найден {{range ...}}
// и имя переменной
// func getRangePropX(in *xlsx.Row) (int, string) {
// 	for i, c := range in.Cells {
// 		match := rangeRgx.FindAllStringSubmatch(c.Value, -1)
// 		if match != nil {
// 			return i, match[0][1]
// 		}
// 	}
